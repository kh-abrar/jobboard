          ...
          <form class="p-4 p-md-5" action="{{route('store.jobs')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <select name="salary" class="selectpicker border rounded form-control" id="job-type" data-style="btn-black" data-width="100%" data-live-search="true" title="Select Salary">
                <option value="50k - 70k BDT">50k - 70k</option>
                <option value="70k - 100k BDT">70k - 100k</option>
                <option value="100k - 150k BDT">100k - 150k</option>
              </select>
            </div>
            ...
            <div class="row form-group">
              <div class="col-md-12">
                ...
                <textarea name="otherbenefits" id="" cols="30" rows="7" class="form-control" placeholder="Write Other Benifits..."></textarea>
              </div>
            </div>
